...
\begin{tikzpicture}
    ...
    \draw[{Circle}-](-1,1.59); %,gray

    % comparison mechanism 
    \node[rectangle,draw] at (-1,-2.2) {$C$}; %,gray
    \draw[{Circle}-](-1,-1.75); %,gray
    ...
    \draw[-{latex}, gray](-7.4,3.67) to (-2.5,3.7) to (-2.5,1.53) to (-1.05,1.53); %,gray
    ...
    \draw[-{latex}, gray](-7.4,-3.67) to (-2.5,-3.67) to (-2.5,1.53) to (-1.05,1.53); %,gray
